    ...
    internal class DemonForcedRage
    {
        ...
        static class BlueprintsCache_Init_Patch
        {
            ...
            static void Postfix()
            {
                ...
                Initialized = true;
                DemonForcedRageAbility();
                DemonForcedRageBuff();
                DemonForcedRageFeature();
            }

            private static readonly LogWrapper Logger = LogWrapper.Get("DemonTweaks.FocredRage");
            ...
            public static void DemonForcedRageBuff()
            {
            ...
            public static void DemonForcedRageFeature()
            {
                ...
                {
                    Logger.Info("Обезврежен");
                    return;
                }
                demonForcedRageFeature.m_DisplayName = LocalizationTool.GetString(demonForcedRageFeatureName);
                demonForcedRageFeature.m_Description = LocalizationTool.GetString(demonForcedRageFeatureDescription);
